...
import { airbnb1, azeorex, check2, grid, loading1, project3, reactShoe } from "../../public";
  ...
  const projects = [
    {
      ...
      date: "Dec 2023",
      status: "done",
      imageUrl: "/projects/airbnb-1.png",
      colorful: true,
    ...
    },
    {
      ...
      date: "Jan 2024",
      status: "done",
      imageUrl: "/projects/reactShoe.png",
      colorful: false,
                ...
                <div className="relative p-8 bg-n-8 rounded-[2.47rem] overflow-hidden xl:p-15">
                  ...
                  <div className=" relative z-1">
                    ...
                    <div className="flex items-center justify-center relative top-0">
                      <div className=" overflow-hidden w-full md:my-5 my-7 md:rounded-2xl rounded-xl aspect-[16/10.5]">
                        <Image
